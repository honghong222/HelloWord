...
public class CalculatorExe {
	public static void main(String[] args) {
		 ...
		 System.out.println("합격"+ cal1.sum(10, 20));
		 System.out.println("합격"+ cal1.sum(10.3, 20));
		 System.out.println("큰값은"+cal1.sum(10, 20.2));
		 cal1.printStar(3);
		 ...
		 System.out.println("최고영어 점수는 "+std.studentEnglish+",이름은"+std.studentName);
